...
\begin{figure}
    \subfloat[2 tube]{{\includegraphics[width=0.33\linewidth]{images/2-tube-workspace.png}}}
    \subfloat[3 tube]{{\includegraphics[width=0.33\linewidth]{images/3-tube-workspace.png}}}
    \subfloat[4 tube]{{\includegraphics[width=0.33\linewidth]{images/4-tube-workspace.png}}}
    \caption{Illustration of robot in full extension with tube rotations 0$^{\circ}$ and 180$^{\circ}$.}
    \label{fig:workspace}
\end{figure}

\begin{figure}
    \subfloat[2 tube Cartesian sampling]{{\includegraphics[width=0.33\linewidth]{images/2-tube-x-y-z.png}}}
    \subfloat[3 tube Cartesian sampling]{{\includegraphics[width=0.33\linewidth]{images/3-tube-x-y-z.png}}}
    \subfloat[4 tube Cartesian sampling]{{\includegraphics[width=0.33\linewidth]{images/4-tube-x-y-z.png}}}
...
\begin{figure}
    \subfloat[2 tube]{{\includegraphics[width=0.33\linewidth]{images/2-tube-learning.eps}}}
    \subfloat[3 tube]{{\includegraphics[width=0.33\linewidth]{images/3-tube-learning.eps}}}
    \subfloat[4 tube]{{\includegraphics[width=0.33\linewidth]{images/4-tube-learning.eps}}}
...
\begin{figure}
    \subfloat[2 tube]{{\includegraphics[width=0.33\linewidth]{images/2-tube-eval.eps}}}
    \subfloat[3 tube]{{\includegraphics[width=0.33\linewidth]{images/3-tube-eval.eps}}}
    \subfloat[4 tube]{{\includegraphics[width=0.33\linewidth]{images/4-tube-eval.eps}}}
...
\begin{figure}
    \subfloat[Type 1]{{\includegraphics[width=0.5\linewidth]{images/exp-1-q-values.eps}}}
    \subfloat[Type 5]{{\includegraphics[width=0.5\linewidth]{images/exp-5-q-values.eps}}}
...
\begin{figure}
    \subfloat[Trajectory]{{\includegraphics[width=0.5\linewidth]{images/exp4-square-0-6.eps}}}
    \subfloat[Error]{{\includegraphics[width=6cm]{images/exp4-square-0-6-error.eps}}}
    \caption{Two tube environment with parameter noise type and 0.6 mm goal tolerance.}
    \label{fig:two-tube-traj}
\end{figure}
\begin{figure}
    \subfloat[Trajectory]{{\includegraphics[width=0.5\linewidth]{images/exp10-square-0-4.eps}}}
    \subfloat[Error]{{\includegraphics[width=0.5\linewidth]{images/exp10-square-0-4-error.eps}}}
    \caption{Two tube environment with parameter noise type and 0.6 mm goal tolerance.}
    \label{fig:three-tube-traj}
\end{figure}
\begin{figure}
    \subfloat[Trajectory]{{\includegraphics[width=0.5\linewidth]{images/exp14-square-0-3.eps}}}
    \subfloat[Error]{{\includegraphics[width=0.5\linewidth]{images/exp14-square-0-3-error.eps}}}
